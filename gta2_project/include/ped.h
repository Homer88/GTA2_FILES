...
struct Ped {
    struct S200 S200[50];
    int Counter;
    char field2_0x9a[146];
    undefined2 field3_0x12c;
    undefined2 field4_0x12e;
    undefined2 field5_0x130;
    undefined2 field6_0x132;
    undefined2 field7_0x134;
    undefined field8_0x136;
    undefined field9_0x137;
    undefined4 field10_0x138;
    undefined4 field11_0x13c;
    undefined4 field12_0x140;
    struct Ped *sPed1;
    struct Ped *Driver;
    struct Ped *LinkedPed;
    struct Car *Car;
    struct Car *ObjectiveTargetCar;
    struct Car *TargetCarForEnter;
    struct Player *Player;
    struct Ped *NextPed;
    struct S169 *pS169;
    struct GameObject *GameObject;
    struct Car *CarCurrent;
    struct Weapon *SelectedWeapon;
    struct Weapon *Weapon1;
    struct Weapon *Weapon;
    struct Gang *Gang;
    struct Ped *PedDriver;
    undefined4 uns15;
    ...
    undefined4 uns62;
    byte uns63;
    enum CarDamageState CarDamageState;
    byte ExitAnimState;
    byte uns66;
    byte uns67;
    byte uns68;
    ...
    byte uns110;
    byte uns111;
    undefined4 GraphicType;
    undefined4 field123_0x270;
    undefined4 GangCarModel;
    enum PedState CurrentState;
    undefined4 field126_0x27c;
    enum PedState SavedState;
    undefined4 field128_0x284;
    undefined4 field129_0x288;
    undefined4 field130_0x28c;
    undefined4 field131_0x290;
};

// Ped function declarations
void Ped__SetSearchType(Ped *this, SearchType type);
void Ped__SetOccupation(Ped *this, int occupation);
int Ped__GetOccupation(Ped *this);
enum PedState Ped__GetCurrentState(Ped *this);
void Ped__SetHealthPlayer(Ped *this, short Health);
bool Ped__GetDeadPed(Ped *this);
Car* Ped__GetCurrentCar(Ped *this);
