...

{
  ...
  iVar5 = Ped__GetActionParam(pPed);
  Ped::PedSetObjective(this->Ped,iVar5,timer);
  uVar4 = Ped::S49_Get_FUN_00403b20(pPed);
  iVar5 = CONCAT22(extraout_var,uVar4);
  uVar6 = Ped__GetCurrentAction(pPed);
  Ped::SetAnimationState(this->Ped,uVar6,iVar5);
  uVar3 = Ped__GetDamageState(pPed);
  Ped__SetVehicleDamageState(this->Ped,uVar3);
  uVar3 = Ped__GetFlags2(pPed);
  Ped__SetExitAnimationState(this->Ped,uVar3);
  uVar6 = Ped__GetPassenger(pPed);
  Ped__SetAsDriver(this->Ped,uVar6);
  uVar6 = Ped__GetVehicle(pPed);
  Ped__EnterCar(this->Ped,uVar6);
  ...
  uVar6 = Ped__GetLinkedPed(pPed);
  Ped__SetLinkedPedestrian(this->Ped,uVar6);
  uVar6 = Ped__GetCurrentVehicle(pPed);
  Ped__SetTargetVehicle(this->Ped,uVar6);
  this->Ped->uns35 = pPed->uns35;
  this->Ped->uns36 = pPed->uns36;
  this->Ped->SpriteS1 = pPed->SpriteS1;
  Ped__SetAssignedCarIndex(this->Ped,99);
  uVar6 = Ped__GetFlags1(pPed);
  Ped__SetTargetCarDoorIndex(this->Ped,uVar6);
  uVar3 = Ped__GetAnimationState(pPed);
  Ped__SetAnimationState(this->Ped,uVar3);
  pS49_1 = this->Ped;
  if (pS49_1->GameObject == (GameObject *)0x0) {
    iVar5 = Ped__GetFlags1(pS49_1);
    if ((iVar5 == 0) && (pS49_1->CarCurrent->Driver != pS49_1)) {
      Ped__SetTargetCarDoorIndex(pS49_1,1);
    }
  }
  else {
  ...
  Ped__SetAssignedCarIndex(this->Ped_Arr9[Index],index);
  ...
  if (pGameGameObject != (GameObject *)0x0) {
    iVar5 = Ped__GetCurrentOccupation(this->Ped_Arr9[Index]);
    if (iVar5 == 0x17) {
  ...
  if ((int)Index < (int)(this->Index - 1)) {
    Ped__ResetToDefaults(this->Ped_Arr9[Index]);
    pS49_1 = this->Ped_Arr9[this->Index - 1];
    this->Ped_Arr9[Index] = pS49_1;
    Ped__SetAssignedCarIndex(pS49_1,index);
  }
  else {
...
LAB_004043b1:
  ...
  Ped__SetCurrentOccupation(pPed,2);
...

{
  ...
  do {
    ...
    PVar2 = Ped__GetStance(this->Ped_Arr9[(char)bVar1]);
  } while (PVar2 != 0);
...

{
  ...
  bVar8 = 0;
  local_24 = this;
  Decoder_ShiftLeft(&local_2c,(void *)0x0);
  bVar1 = this->Index;
...

{
  ...
  pPed1 = this->Ped;
  pS169 = this;
  Index = Ped__GetPedState(pPed1);
  if (((Index == 3) || (Index = Ped__GetPedState(pPed1), Index == 10)) ||
     (Index = Ped__GetPedState(pPed1), Index == 5)) {
    this->field10_0x30 = 1;
    Index = Ped__GetPedState(pPed1);
...
LAB_0040566e:
      ...
      if (Index < (int)(uint)this->Index) {
        do {
          pPed1 = this->Ped_Arr9[Index];
          Index = Ped__GetActionParam(pPed1);
          if (Index != 8) {
  ...
  bVar2 = Ped__GetExitAnimState(pPed1);
  uVar8 = (uint)bVar2;
  if (bVar2 != 0) {
...
LAB_0040e8b7:
  CarPool_Get(param_1,(int)&local_4);
  return param_1;
}
  ...
  if (CONCAT31(extraout_var,bVar3) != 0) {
    ...
    if (CONCAT31(extraout_var_00,bVar3) != 0) {
      ...
      if ((char)piVar7 != '\0') {
        ...
        this_01 = (int *)Decoder_ReadInt(this_00,ppPVar10,piVar7);
        puVar11 = local_10;
        piVar13 = this_01;
        ...
        this_02 = Decoder_ReadInt(this_01,puVar9,piVar7);
        puVar8 = (undefined4 *)
