// Auto-generated structure: _OUTLINETEXTMETRICA
// Source: _OUTLINETEXTMETRICA.txt
// Fields count: 17
...
// static_assert(sizeof(_OUTLINETEXTMETRICA) == EXPECTED_SIZE, "Size mismatch for _OUTLINETEXTMETRICA");
