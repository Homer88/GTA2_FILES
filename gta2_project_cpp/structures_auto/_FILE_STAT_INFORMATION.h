// Auto-generated structure: _FILE_STAT_INFORMATION
// Source: _FILE_STAT_INFORMATION.txt
// Fields count: 7
...
// static_assert(sizeof(_FILE_STAT_INFORMATION) == EXPECTED_SIZE, "Size mismatch for _FILE_STAT_INFORMATION");
