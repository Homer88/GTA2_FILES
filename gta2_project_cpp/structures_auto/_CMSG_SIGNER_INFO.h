// Auto-generated structure: _CMSG_SIGNER_INFO
// Source: _CMSG_SIGNER_INFO.txt
// Fields count: 7
...
// static_assert(sizeof(_CMSG_SIGNER_INFO) == EXPECTED_SIZE, "Size mismatch for _CMSG_SIGNER_INFO");
